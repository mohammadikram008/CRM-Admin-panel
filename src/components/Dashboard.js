...
import isb from "../assets/istockphoto-519767045-1024x1024.jpg";
import isb2 from "../assets/istockphoto-627722178-1024x1024.jpg";
import skr from "../assets/istockphoto-532006651-1024x1024.jpg";
import { useNavigate, useParams } from "react-router-dom";
import {Link ,Navigate} from 'react-router-dom'

const Dashboard = () => {
  const [record, setRecord] = useState([]);
const [alertb,setAlertb]=useState(true);
      ...
      <div class="col main pt-5 mt-3">
        ...
        {alertb && home=="myAlert"?  (
          ...
          >
            ...
            <strong>Data and Records</strong> <a  href="/home">Learn more about employee</a>
          </div>
        ):"" }
        <div class="row mb-3">
        ...
        <div class="row" id="analytic">
          <div class="col-lg-7 col-md-6 col-sm-12">
            ...
            <div class="table-responsive">
              <table class="tbl h-5 table-striped">
          ...
          <div className="col-lg-5 col-md-6 col-sm-12 col-sm-offset-5">
            ...
            <div className="pt-5" style={{ height: "400px", width: "400px" }}>
              <PieChart />{" "}
        ...
        <a id="more"></a>
        <hr />
        <h2 class="sub-header mt-5" id="report">
          ...
          <div class="card-deck">
            <div class="card card-inverse card-success text-center">
              <div class="card-body">
                <blockquote class="card-blockquote">
                  <p>
                    It's really good news that the new Bootstrap 4 now has
                    support for CSS 3 flexbox.
                  </p>
                  <footer>
              ...
              <div class="card-body">
                <blockquote class="card-blockquote">
                  ...
                  <footer>
                    ...
                    <cite title="Source Title">Sense</cite>
                  </footer>
                </blockquote>
              </div>
            </div>
            <div class="card card-inverse card-warning text-center">
              <div class="card-body">
                <blockquote class="card-blockquote">
                  <p>
                    There are also some interesting new text classes for
        ...
        <a id="flexbox"></a>
        <hr />
        <h2 class="mt-5" id="export">Masonry-style grid columns</h2>
        ...
        <div class="card-columns mb-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                breakpoint with the col-xl-* classes. This extra tier extends
                the media query range all the way down to 576 px. Eventhough the
                new XL tier would make one think it’s been added to support
                extra large screens, it’s actually the opposite.
              </p>
            </div>
          </div>
          ...
          <div class="card">
            <img class="card-img img-fluid" src={skr} alt="Card image" />
          </div>
        ...
        <a id="layouts"></a>
        <hr />
        <h2 class="sub-header mt-5" id="flex">Interesting layouts and elements</h2>
        <div class="row mb-3">
          <div class="col-lg-6">
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  All of these Bootstrap 3.x components have been dropped
                  entirely for the new card component.
                </p>
                ...
                <div class="tab-pane" id="tab1">
                  <div class="list-group">
                    <a href="" class="list-group-item">
                      <span class="float-right label label-success">51</span>{" "}
                      Home Link
                    </a>
                    <a href="" class="list-group-item">
                      <span class="float-right label label-success">8</span>{" "}
                      Link 2
                    </a>
                    <a href="" class="list-group-item">
                      <span class="float-right label label-success">23</span>{" "}
                      Link 3
                    </a>
                ...
                <div class="tab-pane active" id="tab2">
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <img
                        src={isb}
                        class=" profile float-right img-responsive img-rounded"
                      />
                    </div>
                  </div>
                  <hr />
              ...
              <div class="card">
                ...
                >
                  <p>
                    ...
                    <code>.card</code> classes instead of <code>.panel</code>.
                    The single-open section aspect is not working because the
                    parent option (dependent on .panel) has not yet been
                    finalized in BS 4 alpha.{" "}
                  </p>
                </div>
                <div
                  class="card-header"
                ...
                >
                  <p>
                    Just like it's predecesor, Bootstrap 4 is mobile-first so
                    that you start by designing for smaller devices such as
                ...
                >
                  <p>
                    ...
                    settings that you’ll need to be aware of when using it, all
                    of which are almost exclusively geared towards the
